...
//bkjung
void commandLeftWheelAngleCallback(const std_msgs::Int32& left_wheel_angle_msg);
void commandRightWheelAngleCallback(const std_msgs::Int32& right_wheel_angle_msg);
...
//////Added by bkjung
ros::Subscriber<std_msgs::Int32> left_wheel_angle_sub("left_wheel_angle", commandLeftWheelAngleCallback);
ros::Subscriber<std_msgs::Int32> right_wheel_angle_sub("right_wheel_angle", commandRightWheelAngleCallback);
//////
...
int32_t left_wheel_angle_from_cmd = 0;
int32_t right_wheel_angle_from_cmd = 0;
